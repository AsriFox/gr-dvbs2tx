...
typedef gr::dvbs2tx::dvbs2_code_rate_t dvbs2_code_rate_t;
typedef gr::dvbs2tx::dvbs2_rolloff_factor_t dvbs2_rolloff_factor_t;
typedef gr::dvbs2tx::dvbs2_constellation_t dvbs2_constellation_t;
typedef gr::dvbs2tx::dvbs2_pilots_t dvbs2_pilots_t;
typedef gr::dvbs2tx::dvbs2_framesize_t dvbs2_framesize_t;
typedef gr::dvbs2tx::dvbs2_ping_reply_t dvbs2_ping_reply_t;
typedef gr::dvbs2tx::dvbs2_ipaddr_spoof_t dvbs2_ipaddr_spoof_t;
typedef gr::dvbs2tx::dvbs2_dummy_frames_t dvbs2_dummy_frames_t;
