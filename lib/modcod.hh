...
#ifndef INCLUDED_DVBS2TX_MODCOD_H
#define INCLUDED_DVBS2TX_MODCOD_H
...
inline bool modcod_is_dvbs2(int modcod) { return modcod < MC_VLSNR_SET1; }

inline bool modcod_is_dvbs2x(int modcod) { return modcod >= MC_VLSNR_SET1; }

inline dvb_framesize_t modcod_framesize(dvbs2_modcod_t modcod)
{
...
inline dvb_code_rate_t modcod_rate(dvbs2_modcod_t modcod)
{
    using namespace gr::dtv;
    switch (modcod) {
    // DVB-S2
...
inline dvb_constellation_t modcod_constellation(dvbs2_modcod_t modcod)
{
    using namespace gr::dtv;
    switch (modcod) {
    // DVB-S2
...
inline dvb_framesize_t vlsnr_framesize(dvbs2_vlsnr_header_t vlsnr_header)
{
    using namespace gr::dtv;
    switch (vlsnr_header) {
...
inline dvb_code_rate_t vlsnr_rate(dvbs2_vlsnr_header_t vlsnr_header)
{
    using namespace gr::dtv;
    switch (vlsnr_header) {
    case VLSNR_N_QPSK_2_9:
...
inline dvb_constellation_t vlsnr_constellation(dvbs2_vlsnr_header_t vlsnr_header)
{
    using namespace gr::dtv;
    switch (vlsnr_header) {
    case VLSNR_N_QPSK_2_9:
