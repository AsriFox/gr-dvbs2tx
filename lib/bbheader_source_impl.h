...
#ifndef INCLUDED_DVBS2TX_BBHEADER_SOURCE_IMPL_H
#define INCLUDED_DVBS2TX_BBHEADER_SOURCE_IMPL_H

#include <gnuradio/dvbs2tx/bbheader_source.h>
#include <arpa/inet.h>
...
#define HEADER_SIZE                                                           \
    ((START_INDICATOR_SIZE + END_INDICATOR_SIZE + LABEL_TYPE_INDICATOR_SIZE + \
      GSE_LENGTH_SIZE) /                                                      \
     8)
...
public:
    bbheader_source_impl(int nstreams,
...
#endif /* INCLUDED_DVBS2TX_BBHEADER_SOURCE_IMPL_H */
