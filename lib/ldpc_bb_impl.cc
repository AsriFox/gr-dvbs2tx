...
ldpc_bb::sptr ldpc_bb::make() { return gnuradio::get_initial_sptr(new ldpc_bb_impl()); }
...
void ldpc_bb_impl::forecast(int noutput_items, gr_vector_int& ninput_items_required)
{
    ninput_items_required[0] = noutput_items;
}

void ldpc_bb_impl::get_nbch(dvb_framesize_t framesize,
...
#define LDPC_BF(TABLE_NAME, ROWS, TABLE)                                   \
    for (usize row = 0; row < ROWS; row++) {                               \
        for (usize n = 0; n < 360; n++) {                                  \
            for (usize col = 1; col <= usize(TABLE_NAME[row][0]); col++) { \
                ldpc_encode[TABLE].p[index] =                              \
                    u16(TABLE_NAME[row][col] + (n * q)) % pbits;           \
...
void ldpc_bb_impl::ldpc_lookup_generate()
{
    u16 im;
    usize index;
    u16 pbits;
    i32 q;
    u32 nbch, q_val, frame_size, frame_size_real;
    i32 Xs, P, Xp, table;

    get_nbch(FECFRAME_NORMAL,
             C1_4,
             &nbch,
             &q_val,
             &frame_size,
...
int ldpc_bb_impl::general_work(int noutput_items,
                               ...
                               gr_vector_void_star& output_items)
{
    ...
    const u8* d;
    u8* p = &out[0];
    u8* b = static_cast<u8*>(output_items[0]);
    u8* s;
    ...
    for (usize i = 0; i < tags.size(); i++) {
        ...
        if (frame_size + produced <= (unsigned int)noutput_items) {
            ...
            if (Xs != 0) {
                ...
                memset(s, 0, sizeof(u8) * Xs);
                memcpy(&s[Xs], &in[consumed], sizeof(u8) * nbch);
                d = s;
            }
            if (P != 0) {
            ...
            for (usize j = 0; j < ldpc_encode[table].table_length; j++) {
            ...
            for (usize j = 1; j < usize(plen - Xp); j++) {
                p[j] ^= p[j - 1];
            }
            produced += plen - Xp;
...
const u16 ldpc_bb_impl::ldpc_tab_1_4N[45][13] = {
...
const u16 ldpc_bb_impl::ldpc_tab_1_3N[60][13] = {
...
const u16 ldpc_bb_impl::ldpc_tab_2_5N[72][13] = {
...
const u16 ldpc_bb_impl::ldpc_tab_1_2N[90][9] = { 
...
const u16 ldpc_bb_impl::ldpc_tab_3_5N[108][13] = {
...
const u16 ldpc_bb_impl::ldpc_tab_2_3N[120][14] = {
...
const u16 ldpc_bb_impl::ldpc_tab_3_4N[135][13] = {
...
const u16 ldpc_bb_impl::ldpc_tab_4_5N[144][12] = {
...
const u16 ldpc_bb_impl::ldpc_tab_5_6N[150][14] = {
...
const u16 ldpc_bb_impl::ldpc_tab_8_9N[160][5] = {
    { 4, 0, 6235, 2848, 3222 },  
    { 4, 1, 5800, 3492, 5348 },  
    { 4, 2, 2757, 927, 90 },     
    { 4, 3, 6961, 4516, 4739 },
...
const u16 ldpc_bb_impl::ldpc_tab_9_10N[162][5] = {
    { 4, 0, 5611, 2563, 2900 },  
    { 4, 1, 5220, 3143, 4813 },  
    { 4, 2, 2481, 834, 81 },     
    { 4, 3, 6265, 4064, 4265 },
...
const u16 ldpc_bb_impl::ldpc_tab_2_9N[40][12] 
= {
...
const u16 ldpc_bb_impl::ldpc_tab_13_45N[52][13] = {
...
const u16 ldpc_bb_impl::ldpc_tab_9_20N[81][13] = {
...
const u16 ldpc_bb_impl::ldpc_tab_11_20N[99][14] = {
...
const u16 ldpc_bb_impl::ldpc_tab_26_45N[104][14] = {
...
const u16 ldpc_bb_impl::ldpc_tab_28_45N[112][12] = {
...
const u16 ldpc_bb_impl::ldpc_tab_23_36N[115][12] = {
...
const u16 ldpc_bb_impl::ldpc_tab_25_36N[125][12] = {
...
const u16 ldpc_bb_impl::ldpc_tab_13_18N[130][11] = {
...
const u16 ldpc_bb_impl::ldpc_tab_7_9N[140][13] = {
...
const u16 ldpc_bb_impl::ldpc_tab_90_180N[90][19] = {
...
const u16
    ldpc_bb_impl::ldpc_tab_96_180N[96][21] = {
...
const u16 ldpc_bb_impl::ldpc_tab_100_180N[100][17] = {
...
const u16 ldpc_bb_impl::ldpc_tab_104_180N[104][19] = {
...
const u16 ldpc_bb_impl::ldpc_tab_116_180N[116][19] = {
...
const u16 ldpc_bb_impl::ldpc_tab_124_180N[124][17] = {
...
const u16 ldpc_bb_impl::ldpc_tab_128_180N[128][16] = {
...
const u16 ldpc_bb_impl::ldpc_tab_132_180N[132][16] = {
...
const u16 ldpc_bb_impl::ldpc_tab_135_180N[135][15] = {
...
const u16 ldpc_bb_impl::ldpc_tab_140_180N[140][16] = {
...
const u16 ldpc_bb_impl::ldpc_tab_154_180N[154][14] = {
...
const u16 ldpc_bb_impl::ldpc_tab_18_30N[108][20] = {
...
const u16 ldpc_bb_impl::ldpc_tab_20_30N[120][17] = {
...
const u16 ldpc_bb_impl::ldpc_tab_22_30N[132][16] = {
...
const u16 ldpc_bb_impl::ldpc_tab_1_4S[9][13] = {
...
const u16 ldpc_bb_impl::ldpc_tab_1_3S[15][13] = {
...
const u16 ldpc_bb_impl::ldpc_tab_2_5S[18][13] = {
...
const u16 ldpc_bb_impl::ldpc_tab_1_2S[20][9] = { 
...
const u16 ldpc_bb_impl::ldpc_tab_3_5S[27][13] = {
...
const u16 ldpc_bb_impl::ldpc_tab_2_3S[30][14] = {
...
const u16 ldpc_bb_impl::ldpc_tab_3_4S[33][13] = {
...
const u16 ldpc_bb_impl::ldpc_tab_4_5S[35][4] = {
    { 3, 5, 896, 1565 },  
    { 3, 6, 2493, 184 },  
    { 3, 7, 212, 3210 },  
    { 3, 8, 727, 1339 },  
...
const u16 ldpc_bb_impl::ldpc_tab_5_6S[37][14] = {
...
const u16 ldpc_bb_impl::ldpc_tab_8_9S[40][5] = {
    { 4, 0, 1558, 712, 805 }, 
    { 4, 1, 1450, 873, 1337 }, 
    { 4, 2, 1741, 1129, 1184 }, 
    { 4, 3, 294, 806, 1566 },
...
const u16 ldpc_bb_impl::ldpc_tab_11_45S[11][11] = {
...
const u16 ldpc_bb_impl::ldpc_tab_4_15S[12][22] = {
...
const u16 ldpc_bb_impl::ldpc_tab_14_45S[14][13] = {
...
const u16 ldpc_bb_impl::ldpc_tab_7_15S[21][25] = {
...
const u16 ldpc_bb_impl::ldpc_tab_8_15S[24][22] = {
...
const u16 ldpc_bb_impl::ldpc_tab_26_45S[26][14] = {
...
const u16 ldpc_bb_impl::ldpc_tab_32_45S[32][13] = {
...
const u16 ldpc_bb_impl::ldpc_tab_1_5M[18][14] = {
...
const u16 ldpc_bb_impl::ldpc_tab_11_45M[22][11] = {
...
const u16 ldpc_bb_impl::ldpc_tab_1_3M[30][13] = {
